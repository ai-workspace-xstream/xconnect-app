...
usage() {
  cat <<'EOF'
Sync the repo-managed XConnect functional baseline skill into Codex local skills.
...
Copies:
  ...
  -> ${CODEX_HOME:-$HOME/.codex}/skills/xconnect-functional-test-baseline
...
TARGET_SKILL="${TARGET_ROOT}/xconnect-functional-test-baseline"
