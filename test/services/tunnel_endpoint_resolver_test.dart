...
void main() {
  group('TunnelEndpointResolver', () {
    ...
    test('reports server domains for the direct-resolution rule', () {
      expect(
        TunnelEndpointResolver.outboundServerDomains(_config()),
        <String>['tky-proxy.svc.plus'],
      );
      expect(
        TunnelEndpointResolver.outboundServerDomains(
          _config(address: '198.51.100.7'),
        ),
        isEmpty,
      );
    });
