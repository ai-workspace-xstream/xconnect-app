...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'connectorDisclaimer':
          'XConnect is a client tool that helps you manage and establish secure connections to your own or authorized network services.',
...
curl -I --proxy socks5h://127.0.0.1:1080 --max-time 15 https://grok.com''',
    ...
    'zh': {
      ...
      'connectorDisclaimer': '本应用为客户端工具，帮助用户管理并建立与自有或授权网络服务的安全连接。',
      'serverAddressHint': 'https://accounts.example.com',
      'settings': '设置',
      'logs': '日志',
      'help': '帮助',
