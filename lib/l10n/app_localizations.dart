...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'xconnectOneJoinTitle': 'Join XConnect-One',
      'xconnectOneJoinDescription':
          'Use an invitation from an authorized XConnect-One network. Enrollment is completed by the shared core and the protected System VPN host.',
      'xconnectOneInviteLabel': 'Invitation',
      'xconnectOneImport': 'Import',
      'xconnectOnePaste': 'Paste',
      'xconnectOneScanQr': 'Scan QR',
      'xconnectOneStatus': 'Enrollment status',
      'xconnectOneJoin': 'Join network',
      'xconnectOneRetry': 'Retry / Resume',
      'xconnectOneClear': 'Clear enrollment state',
      'xconnectOneRuntimeBoundary':
          'Mobile data traffic requires the protected Packet Tunnel host. This build will not report the network as joined until that runtime confirms Apply.',
...
curl -I --proxy socks5h://127.0.0.1:1080 --max-time 15 https://grok.com''',
    ...
    'zh': {
      ...
      'about': '关于',
      'addConfig': '添加连接',
      'xconnectOneJoinTitle': '加入 XConnect-One',
      'xconnectOneJoinDescription':
          '使用已授权 XConnect-One 网络签发的邀请。注册流程由共享核心与受保护的系统 VPN 宿主完成。',
      'xconnectOneInviteLabel': '邀请',
      'xconnectOneImport': '导入',
      'xconnectOnePaste': '粘贴',
      'xconnectOneScanQr': '扫描二维码',
      'xconnectOneStatus': '注册状态',
      'xconnectOneJoin': '加入网络',
      'xconnectOneRetry': '重试 / 恢复',
      'xconnectOneClear': '清除注册状态',
      'xconnectOneRuntimeBoundary':
          '移动端数据流量必须经过受保护的 Packet Tunnel 宿主。在运行时确认 Apply 前，本版本不会报告已加入网络。',
