...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'connectorIntro':
          'Optional workspace sync. Core connections work without an account.',
      'connectorDisclaimer':
          'XConnect is a client tool that helps you manage and establish secure connections to your own or authorized network services. You must deploy and configure your own server to use this feature.',
      'serverAddressHint': 'https://your-server.example.com',
      'settings': 'Settings',
      'logs': 'Logs',
      'help': 'Help',
      'about': 'About',
...
curl -I --proxy socks5h://127.0.0.1:1080 --max-time 15 https://grok.com''',
    ...
    'zh': {
      ...
      'proxy': '连接',
      'connectors': '连接器',
      'connectorIntro': '工作区同步为可选功能；无需账号也可以使用核心连接功能。',
      'connectorDisclaimer':
          '本应用为客户端工具，帮助用户管理并建立与自有或授权网络服务的安全连接。您需要自行部署并配置服务端，才能使用此功能。',
      'serverAddressHint': 'https://your-server.example.com',
      'settings': '设置',
      'logs': '日志',
      'help': '帮助',
